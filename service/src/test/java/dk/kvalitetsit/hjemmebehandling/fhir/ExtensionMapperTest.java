...
public class ExtensionMapperTest {
    ...
    public void mapActivitySatisfiedUntil_maxValue_mapsCorrect_success(String extensionUrl) {
        ...
        assertEquals(extensionUrl, Objects.requireNonNull(result).getUrl());
    ...
    public void mapPhoneHours_success() {
        ...
        assertEquals(Weekday.MON.toString(), result.getExtensionsByUrl(Systems.PHONE_HOURS_WEEKDAY).getFirst().getValue().toString());
