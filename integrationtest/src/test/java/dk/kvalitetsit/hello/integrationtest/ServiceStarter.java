...
public class ServiceStarter {
    ...
    private static final Logger serviceLogger = LoggerFactory.getLogger("hjemmebehandling-patient-bff");
    ...
    public GenericContainer startServicesInDocker() {
        ...
        var resourcesContainerName = "hjemmebehandling-patient-bff-resources";
        ...
        if (resourcesRunning) {
            ...
            service = new GenericContainer<>("local/hjemmebehandling-patient-bff-qa:dev")
        ...
        service.withNetwork(dockerNetwork)
                .withNetworkAliases("hjemmebehandling-patient-bff")
